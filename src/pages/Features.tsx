...
import productImage from "../assets/images/trailerdr-product-image.webp";
import remoteHeroImage from "../assets/images/rechargable-remote-w-flashlight.webp";
import remoteUpgradeImage from "../assets/images/trailer-dr-rechargeable-remote-hero.jpeg";
...
function Features() {
  return (
    <>
      {/*
        Muted bands: section--muted (gradient) then white then section--muted-solid.
        Same pattern as App.css comment.
      */}
      {/* Hero */}
